...
export const mockPolicies = [
  {
    ...
    impactScore: 8.5,
    summary:
      "Comprehensive digital transformation and e-governance initiative for India",
    description:
      "Bill to promote digital literacy, e-governance, and digital payment systems across India. Aims to bridge the digital divide in rural and urban areas.",
    timeline: [
    ...
    sourceLinks: [
      {
        title: "PRS India - Digital India Bill",
        url: "https://www.prs.org.in",
      },
      {
        title: "Ministry Official Page",
  ...
  },
  {
    ...
    description:
      "This act expands the Ayushman Bharat scheme to provide universal health coverage. It aims to provide free treatment for all serious illnesses across India.",
    timeline: [
  ...
  },
  {
    ...
    description:
      "Bill to implement the National Education Policy 2020 reforms including curriculum restructuring, multidisciplinary education, and skill development programs.",
    timeline: [
  ...
  },
  {
    ...
    description:
      "India's commitment to achieve net-zero carbon emissions by 2070. Includes policy for renewable energy expansion, carbon pricing, and green finance initiatives.",
    timeline: [
  ...
  },
  {
    ...
    description:
      "Policy framework to achieve 500 GW of renewable energy generation capacity by 2030. Includes solar, wind, and hybrid energy projects across all states.",
    timeline: [
  ...
  },
  {
    ...
    impactScore: 7.5,
    summary:
      "Worker welfare, minimum wage enhancement, and social security expansion",
    description:
      "Comprehensive amendment to labor codes ensuring better worker protection, minimum wage standards, and expanded social security benefits across all sectors.",
    timeline: [
  ...
  },
  {
    ...
    impactScore: 8.1,
    summary:
      "Farm mechanization, MSP guarantee, and agricultural technology adoption",
    description:
      "Policy to modernize agriculture through mechanization, guaranteed minimum support prices, and adoption of modern farming technologies.",
    timeline: [
  ...
  },
  {
    ...
    impactScore: 8.7,
    summary:
      "National Infrastructure Pipeline expansion and public-private partnerships",
    description:
      "Acceleration of infrastructure development through expanded National Infrastructure Pipeline, PPP models, and increased government spending.",
    timeline: [
  ...
  },
  {
    ...
    impactScore: 7.2,
    summary:
      "Tax rate restructuring and compliance simplification for businesses",
    description:
      "Amendment to direct tax laws to reduce compliance burden, restructure tax slabs, and provide incentives for startups and MSMEs.",
    timeline: [
  ...
  },
  {
    ...
    impactScore: 8.6,
    summary:
      "Universal social security coverage for unorganized sector workers",
    description:
      "Comprehensive social security code ensuring pension, health insurance, and welfare benefits for all workers in the unorganized sector.",
    timeline: [
    ...
    sourceLinks: [
      {
        title: "Social Security Portal",
        url: "https://www.socialsecurity.gov.in",
      },
      { title: "Ministry of Labour", url: "https://www.mol.gov.in" },
    ],
  },
